...
{
    public partial class SelectTypeForm : System.Windows.Forms.Form
    {
        ...
        {            
            ...
            XmlElement config = SmartSchool.Customization.Data.SystemInformation.Preference[_preferenceElementName];
            if (config != null)
            {
            ...
            else
            {
                ...
                SmartSchool.Customization.Data.SystemInformation.Preference[_preferenceElementName] = config;
                #endregion
            }
        ...
        {
            foreach (XmlElement var in (SmartSchool.Customization.Data.SystemInformation.Fields["Period"] as XmlElement).SelectNodes("Period"))
            {
                if (!typeList.Contains(var.GetAttribute("Type")))
                    typeList.Add(var.GetAttribute("Type"));
            }

            foreach (XmlElement var in (SmartSchool.Customization.Data.SystemInformation.Fields["Absence"] as XmlElement).SelectNodes("Absence"))
            {
