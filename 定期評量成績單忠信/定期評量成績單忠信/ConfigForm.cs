...
namespace 定期評量成績單.忠信
{
    public partial class ConfigForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        private List<Configure> _Configures = new List<定期評量成績單.忠信.Configure>();
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            rankDisplayDatum = int.MaxValue ;
            int.TryParse(tbRankDisplayDatum.Text,out rankDisplayDatum);
